...
**图片搜索：** Google 图片、百度图片、必应图片、Unsplash、Pexels、Pixabay、Flickr、CC Search、Iconfinder、FindIcons、LibreStock

**书籍/文档：** Google 图书搜索、鸠摩搜书、Ebooke

**其他：** 知乎搜索、头条搜索、搜狗微信搜索、B 站搜索、Reddit 搜索、IMDb 影视搜索、Bandcamp 音乐、Wayback Machine 存档检索、全历史、TinEye、Tunefind、SimilarSites、SimilarWeb、visualcapitalist、ProSettings、BetaWiki、TOP 500、The Pudding
...
**路径 1 — bs4 CSS 选择器：** 为百度、Google、必应等主流引擎预定义容器/标题/链接/摘要选择器，精确提取。

**路径 2 — sklearn 文本模式：** 不依赖 CSS，用 TF-IDF 向量化所有带链接的文本块，计算与关键词的余弦相似度，过滤低分候选。
